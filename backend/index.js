...
app.use(
  cors({
    'Access-Control-Allow-Origin': 'https://notesapp-client-sage.vercel.app',
...
app.get("/get-all-notes", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    return res.json({
      error: false,
      notes,
      message: "All notes retrieved Successful",
    });
...
app.get("/search-notes", authenticateToken, async (req, res) => {
 ...
 try {
    ...
    return res.json({
      error: false,
      notes: matchingNotes,
      message: "Notes matching with search query retries successful"
